...
const CORES: Record<string, string[]> = {
  ...
  'Execução & Operação': ['249,115,22', '251,146,60', '234,88,12'],
  'Cliente & Mercado': ['250,204,21', '245,158,11', '253,224,71'],
  'Financeiro': ['16,185,129', '5,150,105', '52,211,153'],
  'Inovação & Criatividade': ['168,85,247', '192,132,252', '139,92,246'],
  'Cultura & Valores': ['203,213,225', '148,163,184', '226,232,240'],
}
